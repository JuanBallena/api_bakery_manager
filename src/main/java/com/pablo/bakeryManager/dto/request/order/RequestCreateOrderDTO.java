...
public class RequestCreateOrderDTO implements RequestDTO {
	...
	private List<RequestOrderDetail> orderDetailList;
	...
	private void getJsonProperties(Map<String, Object> order) {
		...
		orderDetailList = (List<RequestOrderDetail>) data.get("orderDetailList");
	}
	...
	public List<RequestOrderDetail> getOrderDetailList() {
		
		ObjectMapper mapper = new ObjectMapper();
		List<RequestOrderDetail> orderDetailList = mapper
				.convertValue(this.orderDetailList, new TypeReference<List<RequestOrderDetail>>() { });
